 ...
 class Auth extends Illuminate\Support\Facades\Auth{
	 ...
	 */
	 public static function attempting($callback){
		 static::$root->attempting($callback);
	 }
 ...
 class Sentry extends Cartalyst\Sentry\Facades\Laravel\Sentry{
	 ...
	 */
	 public static function __construct($userProvider = null, $groupProvider = null, $throttleProvider = null, $session = null, $cookie = null, $ipAddress = null){
		 static::$root->__construct($userProvider, $groupProvider, $throttleProvider, $session, $cookie, $ipAddress);
	 }
	 ...
	 */
	 public static function register($credentials, $activate = false){
		return static::$root->register($credentials, $activate);
	 }
	 ...
	 */
	 public static function authenticate($credentials, $remember = false){
		return static::$root->authenticate($credentials, $remember);
	 }
	 ...
	 */
	 public static function authenticateAndRemember($credentials){
		return static::$root->authenticateAndRemember($credentials);
	 }
	 ...
	 */
	 public static function loginAndRemember($user){
		 static::$root->loginAndRemember($user);
	 }
	 ...
	 */
	 public static function setGroupProvider($groupProvider){
		 static::$root->setGroupProvider($groupProvider);
	 }
	 ...
	 */
	 public static function getGroupProvider(){
		return static::$root->getGroupProvider();
	 }
	 ...
	 */
	 public static function setUserProvider($userProvider){
		 static::$root->setUserProvider($userProvider);
	 }
	 ...
	 */
	 public static function getUserProvider(){
		return static::$root->getUserProvider();
	 }
	 ...
	 */
	 public static function setThrottleProvider($throttleProvider){
		 static::$root->setThrottleProvider($throttleProvider);
	 }
	 ...
	 */
	 public static function getThrottleProvider(){
		return static::$root->getThrottleProvider();
	 }
	 ...
	 */
	 public static function setIpAddress($ipAddress){
		 static::$root->setIpAddress($ipAddress);
	 }
	 ...
	 */
	 public static function getIpAddress(){
		return static::$root->getIpAddress();
	 }
 ...
 class QueryBuilder{
	 ...
	 */
	 public static function dynamicWhere($method, $parameters){
		return static::$root->dynamicWhere($method, $parameters);
	 }
	 ...
	 */
	 public static function union($query, $all = false){
		return static::$root->union($query, $all);
	 }
	 ...
	 */
	 public static function unionAll($query){
		return static::$root->unionAll($query);
	 }
	 ...
	 */
	 public static function mergeBindings($query){
		return static::$root->mergeBindings($query);
	 }
